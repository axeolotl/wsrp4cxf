 ...
 *       &lt;sequence>
 *         &lt;element name="properties" type="{urn:oasis:names:tc:wsrp:v1:types}Property" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="resetProperties" type="{urn:oasis:names:tc:wsrp:v1:types}ResetProperty" maxOccurs="unbounded" minOccurs="0"/>
...
public class PropertyList {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the resetProperties property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
